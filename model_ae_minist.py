...
class Model(nn.Module):
    def __init__(self, startf=32, maxf=256, layer_count=3, latent_size=128, mapping_layers=5, dlatent_avg_beta=None,
                 ...
                 generator="", encoder="", mapping_to_latent="", mapping_from_latent=""):
        ...
        self.mapping_fl = MAPPINGS[mapping_from_latent](
    ...
    def forward(self, x, lod, blend_factor, d_train, ae, alt):
        ...
        Xr = self.decoder(Z, lod, blend_factor, True)

        Lae = F.binary_cross_entropy(Xr, x.detach())
